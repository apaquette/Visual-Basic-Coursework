...
Partial Public Class MMABooksDataSet
    ...
    Partial Public Class CustomersDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Overloads Function AddCustomersRow(ByVal Name As String, ByVal Address As String, ByVal City As String, ByVal State As String, ByVal ZipCode As String) As CustomersRow
            Dim rowCustomersRow As CustomersRow = CType(Me.NewRow,CustomersRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, Name, Address, City, State, ZipCode}
...
Namespace MMABooksDataSetTableAdapters
    ...
    Partial Public Class CustomersTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [Customers] WHERE (([CustomerID] = @Original_CustomerID) AND ([Name] "& _ 
                "= @Original_Name) AND ([Address] = @Original_Address) AND ([City] = @Original_Ci"& _ 
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [Customers] ([Name], [Address], [City], [State], [ZipCode]) VALUES (@"& _ 
                "Name, @Address, @City, @State, @ZipCode);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT CustomerID, Name, Address, Cit"& _ 
                "y, State, ZipCode FROM Customers WHERE (CustomerID = SCOPE_IDENTITY()) ORDER BY "& _ 
                "Name"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [Customers] SET [Name] = @Name, [Address] = @Address, [City] = @City, [Sta"& _ 
                "te] = @State, [ZipCode] = @ZipCode WHERE (([CustomerID] = @Original_CustomerID) "& _ 
                "AND ([Name] = @Original_Name) AND ([Address] = @Original_Address) AND ([City] = "& _ 
                "@Original_City) AND ([State] = @Original_State) AND ([ZipCode] = @Original_ZipCo"& _ 
                "de));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT CustomerID, Name, Address, City, State, ZipCode FROM Customers WHE"& _ 
                "RE (CustomerID = @CustomerID) ORDER BY Name"
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.CustomerMaintenance.My.MySettings.Default.MMABooksConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT        CustomerID, Name, Address, City, State, ZipCode"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            Cu"& _ 
                "stomers"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"ORDER BY Name"
