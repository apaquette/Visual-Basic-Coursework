Public Class frmPayment
    ...
    Private Sub frmPayment_Load(sender As Object,
        ...
        Dim months() As String = {"Select a month...",
    ...
    Private Sub SaveData()
        ...
        If rdoCreditCard.Checked Then
            message = "Charge to credit card." & vbCrLf & vbCrLf &
                      "Card type: " & lstCreditCardType.Text & vbCrLf &
                      "Card number: " & txtCardNumber.Text & vbCrLf &
                      "Expiration date: " & cboExpirationMonth.Text &
                      "/" & cboExpirationYear.Text & vbCrLf
        Else
            message = "Send bill to customer." & vbCrLf & vbCrLf
        End If

        Dim isDefaultBilling As Boolean = chkDefault.Checked
    ...
    Private Sub BillingChecked(sender As Object,
            e As EventArgs) Handles rdoCreditCard.CheckedChanged,
            rdoBillCustomer.CheckedChanged
        If rdoCreditCard.Checked Then
            Me.EnableControls()
        Else
            Me.DisableControls()
